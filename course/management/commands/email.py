...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        text_content = course.title + ' for ' + term.name + ' is now ' + status + '. Click here to view the course page: https://opencourseproject.com/course/' + str(term.value) + '/' + str(course.crn) + '/'
        html_content = '<p><strong>' + course.title + '</strong> for ' + term.name + ' is now <strong>' + status + '</strong>.</p><p>Click here to view the course page: https://opencourseproject.com/course/' + str(term.value) + '/' + str(course.crn) + '/</p>'
