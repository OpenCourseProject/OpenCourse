    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rmp_score', models.DecimalField(null=True, verbose_name=b'Rating', max_digits=2, decimal_places=1)),
                ('rmp_link', models.URLField(max_length=100, null=True, verbose_name=b'RateMyProfessor Link')),
        ...
        migrations.AddField(
            model_name='course',
            name='instructor',
            field=models.ForeignKey(verbose_name=b'Instructor', to='course.Instructor', null=True),
        ),
        migrations.AddField(
            model_name='course',
            name='meeting_times',
            field=models.ManyToManyField(to='course.MeetingTime'),
        ),
        migrations.AddField(
            model_name='course',
            name='term',
