...
from opencourse.views import home, about, dashboard, report, changes, updates, error_500, error_404
admin.autodiscover()
...
urlpatterns = patterns('',
    ...
    url(r'^internal/changes/', changes, name='changes'),
    url(r'^internal/updates/', updates, name='updates'),
)
