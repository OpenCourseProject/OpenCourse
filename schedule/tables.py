...
class ScheduleTable(tables.Table):
    days = tables.Column(accessor='primary_meeting_time.days', order_by='primary_meeting_time.days')
    start_time = tables.Column(accessor='primary_meeting_time.start_time', order_by='primary_meeting_time.start_time')
    end_time = tables.Column(accessor='primary_meeting_time.end_time', order_by='primary_meeting_time.end_time')
